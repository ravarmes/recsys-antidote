...
n_users=  300
n_movies= 500
top_users = False # True: para utilizar os usuários com mais avaliações; False: caso contrário

X, genres, user_info = MF.read_movielens_1M(n_movies, n_users, top_users, data_dir = Data_path+'MovieLens-1M') # retorna a matriz de avaliações com n_users linhas e n_moveis colunas
